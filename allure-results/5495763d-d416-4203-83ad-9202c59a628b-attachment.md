...
Call log:
  - waiting for getByText('Return to previous page')
    - locator resolved to <a tabindex="0" aria-current="page" _ngcontent-dsn-c273="" data-id="claimsGoBack">…</a>
  - attempting click action
    ...
    at ClaimsPage.openClaimAndReturn (/home/karthi/pmp/src/pages/ClaimsPage.js:392:29)
