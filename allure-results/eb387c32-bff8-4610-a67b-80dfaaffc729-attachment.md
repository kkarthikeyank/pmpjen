...
Call log:
  - waiting for locator('//button[@id="dropdownDateFilterButton"]')
    - locator resolved to <button type="button" aria-expanded="false" _ngcontent-aor-c283="" data-bs-toggle="dropdown" id="dropdownDateFilterButton" data-id="dropdownDateFilterButton" class="btn btn-outline-gray btn-block dropdown-toggle text-left font-size-sm w-100"> Last 36 Months </button>
