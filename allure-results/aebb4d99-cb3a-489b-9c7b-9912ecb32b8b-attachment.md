...
- Location: /home/karthi/pmp/src/tests/labspagegroup.spec.js:29:3

# Error details

```
Error: expect.toBeVisible: Error: strict mode violation: locator('text=Labs') resolved to 2 elements:
    1) <span _ngcontent-avq-c113="" class="font-size-xs fw-bold"> Labs </span> aka getByRole('link', { name: 'navbarLinkIcon Labs' })
    2) <div _ngcontent-avq-c196="" data-id="navCard-2-Title" class="card-text fw-bold d-flex justify-content-center text-nowrap"> Labs </div> aka getByRole('link', { name: 'Labs', exact: true })

Call log:
  - expect.toBeVisible with timeout 10000ms
  - waiting for locator('text=Labs')

    at /home/karthi/pmp/src/tests/labspagegroup.spec.js:33:50
```
...
> 33 |     await expect(labs.page.locator('text=Labs')).toBeVisible();
  ...
  36 |   });
  37 |
  38 |      test('Search and log lab results for multiple test cases', async () => {
