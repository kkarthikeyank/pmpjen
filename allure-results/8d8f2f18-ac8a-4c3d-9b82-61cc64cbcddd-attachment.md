...
Call log:
  - waiting for getByRole('textbox', { name: 'ex. Life Labs' }) to be visible

    at LabsPage.openlabsTab (/home/karthi/pmp/src/pages/LabsPage.js:59:27)
...
>  59 | await this.labSearchInput.waitFor({ state: 'visible', timeout: 10000 });
      |                           ^ Error: locator.waitFor: Test timeout of 70000ms exceeded.
   60 |
   61 |   }
