...
Call log:
  - waiting for getByRole('textbox', { name: 'ex. Triglycerides' })
    - locator resolved to <input type="text" _ngcontent-qse-c283="" formcontrolname="filterTests" id="labsFilterTestSearchInput" placeholder="ex. Triglycerides" data-id="labsFilterTestSearchInput" class="form-control ng-untouched ng-pristine ng-valid"/>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <span _ngcontent-qse-c107="" class="nav-stripe w-100 mx-0 px-0 mb-2"></span> from <app-navbar _nghost-qse-c107="" _ngcontent-qse-c115="" data-id="appNavbar-sideBarLayout">…</app-navbar> subtree intercepts pointer events
  ...
  - retrying click action
    ...
    at LabsPage.searchTestName (/home/karthi/pmp/src/pages/LabsPage.js:158:34)
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:218:14
```
