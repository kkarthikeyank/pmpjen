...
Call log:
  - waiting for locator('text=Claim Details') to be visible
    ...
    at ClaimsPage.openClaimAndReturn (/home/karthi/pmp/src/pages/ClaimsPage.js:384:21)
...
```ts
  ...
  357 |     }
  358 |
  359 |     await this.page.waitForTimeout(3000);
  360 |
  361 |     // Get claims
  ...
  379 |     console.log(`→ Opening claim ${claimIndex}...`);
  380 |     
  381 |     const claimDetailButton = this.viewDetailsButton.nth(claimIndex - 1); // Use nth for 0-indexed array
  382 |     await claimDetailButton.click();
  383 |
> 384 |     await this.page.waitForSelector('text=Claim Details', { timeout: 10000 });
      |                     ^ Error: page.waitForSelector: Test timeout of 70000ms exceeded.
  385 |     console.log(`✅ Claim ${claimIndex} details page opened.`);
  386 |
  387 |     await this.returnButton.click();
  388 |     console.log(`↩️ Returned to previous page after Claim ${claimIndex}.`);
  389 |   }
  390 |   
  391 |   // async verifyNoResults() {
  392 |   //   await expect(this.noResultsText).toBeVisible();
  393 |   // }
  394 |  }
  395 |
  396 |
