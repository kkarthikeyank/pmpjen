...
Call log:
  - waiting for locator('//span[normalize-space()=\'Filter Results\']')
    - locator resolved to <span _ngcontent-ulm-c277="">Filter Results</span>
  ...
  2 × retrying click action
      ...
      - done scrolling
      - <div _ngcontent-ulm-c277="" class="d-flex flex-wrap" data-id="claimsFilterResults">…</div> intercepts pointer events
