...
Call log:
  - waiting for locator('//button[@id=\'applyFilterClaims\']')
    - locator resolved to <button disabled tabindex="0" aria-current="page" _ngcontent-hvw-c274="" id="applyFilterClaims" class="btn btn-primary" aria-label="applyFilters">…</button>
