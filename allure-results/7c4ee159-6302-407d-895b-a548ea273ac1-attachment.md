...
Call log:
  - waiting for getByRole('button', { name: 'Apply' })
    - locator resolved to <button type="submit" data-id="filter" id="submitButton" aria-current="page" _ngcontent-vja-c283="" class="btn btn-primary">…</button>
  - attempting click action
    ...
    at LabsPage.searchTestName (/home/karthi/pmp/src/pages/LabsPage.js:160:28)
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:218:3
```
