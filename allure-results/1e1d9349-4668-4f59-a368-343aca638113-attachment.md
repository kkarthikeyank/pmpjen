...
Call log:
  - waiting for locator('//button[@tabindex=\'0\' and text()=\' View Details \']').nth(1) to be visible
    ...
    at ClaimsPage.openClaimAndReturn (/home/karthi/pmp/src/pages/ClaimsPage.js:360:27)
    at ClaimsPage.filterByCustomDateRangeAndPrintClaims (/home/karthi/pmp/src/pages/ClaimsPage.js:333:14)
...
```ts
  ...
  308 |
  309 |     await this.dateFilterButton.waitFor({ state: 'visible', timeout: 50000 });
