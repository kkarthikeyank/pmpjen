...
Call log:
  - waiting for locator('#navLink-LABS')
    - locator resolved to <a title="Labs" href="#/labs" id="navLink-LABS" aria-current="page" aria-expanded="true" _ngcontent-hpq-c113="" routerlinkactive="active" class="nav-link text-light rounded-2 d-flex flex-column align-items-center justify-content-center">…</a>
  - attempting click action
    ...
    at LabsPage.openlabsTab (/home/karthi/pmp/src/pages/LabsPage.js:74:24)
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:153:3
```
