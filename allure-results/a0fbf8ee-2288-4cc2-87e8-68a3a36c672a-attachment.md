...
Call log:
  - waiting for locator('text=Loading...') to be detached
    5 × locator resolved to visible <span _ngcontent-cng-c283="" class="visually-hidden">Loading...</span>

    at LabsPage.waitForLoadingToFinish (/home/karthi/pmp/src/pages/LabsPage.js:65:48)
    at LabsPage.selectDateFilter (/home/karthi/pmp/src/pages/LabsPage.js:81:16)
    at LabsPage.searchphysicianinput (/home/karthi/pmp/src/pages/LabsPage.js:126:18)
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:177:14
```
...
>  65 |     await this.page.locator('text=Loading...').waitFor({ state: 'detached', timeout: 10000 });
  ...
  160 |     await expect(labResult).toBeVisible(); // assertion
  161 |
  162 |     // ✅ console log lab result text
  163 |     const labText = await labResult.textContent();
  164 |     console.log('✅ Found Lab Result:', labText?.trim());
  165 |
```