...
Call log:
  - waiting for getByText('Last 60 Months')
    - locator resolved to <li tabindex="0" data-id="undefined-5" _ngcontent-kwp-c283="" class="dropdown-item font-size-sm"> Last 60 Months </li>
  - attempting click action
    - waiting for element to be visible, enabled and stable

    at LabsPage.selectDateRangetestname (/home/karthi/pmp/src/pages/LabsPage.js:154:42)
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:200:3
```
