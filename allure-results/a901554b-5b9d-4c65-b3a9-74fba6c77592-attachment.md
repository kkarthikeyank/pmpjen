...
- Location: /home/karthi/pmp/src/tests/claimspagegroup.spec.js:39:3
...
Locator: locator('#LAST_60_MONTHSradio')
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for locator('#LAST_60_MONTHSradio')

    at Function.filterClaimsAndSelectProviders (/home/karthi/pmp/src/pages/ClaimsPage.js:407:28)
    at /home/karthi/pmp/src/tests/claimspagegroup.spec.js:41:5
```
...
```ts
  ...
  400 |
  401 | await page.locator('text=Loading...').waitFor({ state: 'detached', timeout: 10000 });
  402 |
  403 | await dateFilterButton.waitFor({ state: 'visible', timeout: 10000 });
  404 | await dateFilterButton.click();
  405 |
  406 | const radioLocator = page.locator(`#${filterId}`);
