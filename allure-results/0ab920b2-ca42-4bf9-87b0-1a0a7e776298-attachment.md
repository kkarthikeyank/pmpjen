...
Call log:
  - waiting for locator('#labsFilterPhysicianSearchInput')
    - locator resolved to <input type="text" _ngcontent-bkg-c283="" placeholder="ex. John Smith" formcontrolname="filterPhysician" id="labsFilterPhysicianSearchInput" data-id="labsFilterPhysicianSearchInput" class="form-control ng-valid ng-untouched ng-pristine"/>
  - attempting click action
    ...
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:144:16
```
