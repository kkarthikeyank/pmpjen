...
Call log:
  - waiting for locator('#navLink-LABS')
    - locator resolved to <a title="Labs" href="#/labs" id="navLink-LABS" aria-current="page" aria-expanded="true" _ngcontent-yxp-c113="" routerlinkactive="active" class="nav-link text-light rounded-2 d-flex flex-column align-items-center justify-content-center">…</a>
  - attempting click action
    ...
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:154:3
```
