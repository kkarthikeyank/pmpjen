...
Call log:
  - waiting for getByRole('button', { name: 'Apply' })
    - locator resolved to <button type="submit" aria-current="page" _ngcontent-tqr-c276="" data-id="claimsSubmit" class="btn btn-primary">…</button>
  ...
  - retrying click action
    ...
    at ClaimsPage.filterByClaimNumber (/home/karthi/pmp/src/pages/ClaimsPage.js:84:28)
