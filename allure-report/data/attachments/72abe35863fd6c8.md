...
Call log:
  - waiting for getByRole('button', { name: 'Done' })
    - locator resolved to <button tabindex="0" _ngcontent-fka-c276="" class="btn btn-primary btn-sm h-auto flex-fill"> Done </button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div class="modal-footer" _ngcontent-fka-c98="" data-id="Confirmation Modal MODAL.ERROR_MESSAGE_GENERAL">…</div> from <modal-container role="dialog" tabindex="-1" aria-modal="true" class="modal fade show">…</modal-container> subtree intercepts pointer events
  ...
  - retrying click action
    ...
    at ClaimsPage.filterByCustomDateRange (/home/karthi/pmp/src/pages/ClaimsPage.js:115:25)
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:47:1
```
...
- button "10-28-2024 - 04-28-2025"
- button "Apply"
- button "Clear"
- text: "Date range: from 10-28-2024 to 04-28-2025"
