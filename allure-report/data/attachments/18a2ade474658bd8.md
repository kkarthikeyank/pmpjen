...
Call log:
  - waiting for locator('#navLink-CLAIMS')
    - locator resolved to <a title="Claims" href="#/claims" aria-current="page" id="navLink-CLAIMS" aria-expanded="true" _ngcontent-cnc-c113="" routerlinkactive="active" class="nav-link text-light rounded-2 d-flex flex-column align-items-center justify-content-center">…</a>
  - attempting click action
    ...
    at /home/karthi/pmp/src/tests/claimspagegroup.spec.js:40:5
```
