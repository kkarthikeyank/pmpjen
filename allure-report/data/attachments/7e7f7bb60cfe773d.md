...
Call log:
  - waiting for getByRole('button', { name: 'Clear' })
    ...
    at LabsPage.filterByDateRange (/home/karthi/pmp/src/pages/LabsPage.js:134:29)
...
```ts
   34 |     // this.startDate = page.locator('//div[@aria-label="Thursday, January 2, 2025"]');
   35 |     // this.endDate = page.locator('//div[@aria-label="Saturday, November 30, 2024"]');
   36 |
   37 |    
   38 |
   39 |
