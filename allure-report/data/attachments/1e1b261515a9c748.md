...
```ts
   ...
   21 |
   22 |     this.within10MilesListItem = page.locator('[data-id="providers-filter-distance-WITHIN_10_MILES"]');
...
>  41 |     await this.doctorsType.click();
   ...
   91 |     await this.within10MilesButton.waitFor({ state: 'visible' });  // This will wait until the element is visible
   92 |     
   ...
   97 |     await this.within10MilesButton.click();
   98 |   
