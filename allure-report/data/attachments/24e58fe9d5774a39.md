...
- Location: /home/karthi/pmp/src/tests/claimspagegroup.spec.js:29:5
...
Call log:
  - waiting for getByRole('button', { name: 'Apply' })
    - locator resolved to <button type="submit" aria-current="page" _ngcontent-lcf-c276="" data-id="claimsSubmit" class="btn btn-primary">…</button>
  ...
  - retrying click action
    ...
    at /home/karthi/pmp/src/tests/claimspagegroup.spec.js:33:9
```
