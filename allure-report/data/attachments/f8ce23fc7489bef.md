...
Call log:
  - waiting for getByLabel('Logout')
    - locator resolved to <a tabindex="0" type="button" aria-label="Logout" class="dropdown-item" _ngcontent-vai-c107="" id="dropdownItemLogoutButton">…</a>
  - attempting click action
    ...
    at ProviderPage.logout (/home/karthi/pmp/src/pages/ProviderPage.js:118:29)
...
```ts
  ...
  116 |
  117 | async logout() {
> 118 |     await this.logoutButton.click();
      |                             ^ TimeoutError: locator.click: Timeout 10000ms exceeded.
  119 | }
  120 |   }
  121 |
