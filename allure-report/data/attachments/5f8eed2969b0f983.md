...
Error: locator.uncheck: Error: strict mode violation: getByRole('checkbox', { name: 'Integra Partners Llc_payee' }) resolved to 2 elements:
    1) <input type="checkbox" _ngcontent-wvw-c97="" class="form-check-input me-2" id="Integra Partners Llc_payee" name="Integra Partners Llc_payee" value="Integra Partners Llc_payee" aria-label="Integra Partners Llc_payee"/> aka getByRole('checkbox', { name: 'Integra Partners Llc_payee' }).first()
    2) <input type="checkbox" _ngcontent-wvw-c97="" class="form-check-input me-2" id="Integra Partners Llc_payee" name="Integra Partners Llc_payee" value="Integra Partners Llc_payee" aria-label="Integra Partners Llc_payee"/> aka getByRole('checkbox', { name: 'Integra Partners Llc_payee' }).nth(1)
