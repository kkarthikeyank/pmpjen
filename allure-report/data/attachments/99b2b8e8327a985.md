...
Call log:
  - waiting for getByRole('button', { name: 'Search' })
    ...
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:114:20
```
...
>  62 |     await this.searchButton.click();
  ...
  106 |
  107 |
  108 |     const selectedPlan = (await this.healthPartnersText.textContent()).trim();
  109 |     await expect(this.healthPartnersText).toHaveText(selectedPlan);
  110 |
