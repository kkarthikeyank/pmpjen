...
Call log:
  - waiting for getByRole('textbox', { name: 'ex. Life Labs' })
    - locator resolved to <input type="text" _ngcontent-csf-c283="" placeholder="ex. Life Labs" formcontrolname="filterVendors" id="labsFilterVendorSearchInput" data-id="labsFilterVendorSearchInput" class="form-control ng-untouched ng-pristine ng-valid"/>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <span _ngcontent-csf-c107="" class="nav-stripe w-100 mx-0 px-0 mb-2"></span> from <app-navbar _nghost-csf-c107="" _ngcontent-csf-c115="" data-id="appNavbar-sideBarLayout">…</app-navbar> subtree intercepts pointer events
  ...
  - retrying click action
    ...
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:107:12
```
