...
Call log:
  - waiting for locator('#dpToDateInput')
    - locator resolved to <input type="text" tabindex="0" name="dpToDate" ngbdatepicker="" id="dpToDateInput" autocomplete="off" firstdayofweek="7" navigation="select" _ngcontent-hui-c277="" placement="bottom-end" placeholder="mm/dd/yyyy" formcontrolname="endDateTextField" class="form-control ng-untouched ng-pristine ng-valid" aria-label="Use enter key to pick a date from calendar widget or Enter the date"/>
  ...
  - retrying click action
    ...
    at ClaimsPage.filterByCustomDateRange (/home/karthi/pmp/src/pages/ClaimsPage.js:111:26)
    at /home/karthi/pmp/src/tests/claimsearch.spec.js:73:1
```
...
- button "10-29-2024 - 04-29-2025"
- button "Apply"
- button "Clear"
- text: "Date range: from 10-29-2024 to 04-29-2025"
